...
class ConfigClass:
    ...
    def make_new_Config_file(self):
        ...
        #Generelle Einstellungen f�r Export
...
class PostprocessorClass:
    def __init__(self, config=None, textbox=None, FOLDER='', APPNAME='', VERSION='', DATE=''):
        ...
        #Leser der Files im Config Verzeichniss f�r Postprocessor
        try:
...
#        #Variablen erstellen zur sp�teren Verwendung im Postprozessor        
#        self.get_all_vars()
#        textbox.prt(str(self),1)        
