...
class Plugin(object):
    ...
    EXPORT_MENU_ENTRY =    "fail on initialize - SHOULD NOT BE VISIBLE"
    """menu entry displayed for the export() method

       unused if no export() method defined - leave here nevertheless
    """
        
    TRANSFORM_MENU_ENTRY = "fail on initialize - SHOULD NOT BE VISIBLE"
    """menu entry displayed for the transform() method
    
        unused if no export() method defined - leave here nevertheless
    """
        
    DESCRIPTION =   'fail plugin for DXF2gcode'
...
#        self.vs.display_pane(self.vs.instance_name)
        ...
        # demonstrate failed initialization
        return False
