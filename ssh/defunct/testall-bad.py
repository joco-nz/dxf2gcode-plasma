...
class Windoof:
    ...
    #        add_param_nb(self.frame_l)
        ...
        self.create_menu = Menu(self.menu) 
        self.menu.add_cascade(label="Apply",menu=self.create_menu)    
...
#        create_menu.add_separator()
        ...
        self.menu.entryconfigure(3, menu=self.create_menu)
