...
class TspOptimization(object):
    ...
    def __init__(self, st_end_points=[], order=[]):
        ...
        self.Fittness = FittnessClass(population=self.Population,
                                      cur_fittness=list(range(self.Population.size[1])))
...
class PopulationClass:
    ...
    def tr(self, string_to_translate):
        ...
        """
        return QCoreApplication.translate("PopulationClass", string_to_translate, None)
...
class DistanceMatrixClass:
    ...
    def generate_matrix(self, st_end_points):
        ...
        generate_matrix()
        """
        x_vals = list(range(len(st_end_points)))
        self.matrix = []
