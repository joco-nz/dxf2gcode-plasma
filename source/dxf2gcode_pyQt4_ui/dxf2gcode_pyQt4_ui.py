...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startAtXLabel.setText(_translate("MainWindow", "Start at X [mm]", None))
        self.startAtYLabel.setText(_translate("MainWindow", "Start at Y [mm]", None))
        self.label_6.setText(_translate("MainWindow", "Z retraction area [mm]", None))
        self.label_5.setText(_translate("MainWindow", "Z safety margin [mm]", None))
        self.label_9.setText(_translate("MainWindow", "Z infeed depth [mm]", None))
        self.label_14.setText(_translate("MainWindow", "Workpiece top Z [mm]", None))
        ...
        self.label_8.setText(_translate("MainWindow", "Z final mill depth [mm]", None))
        self.label_7.setText(_translate("MainWindow", "G1 feed XY-directions [mm/min]", None))
        self.label_10.setText(_translate("MainWindow", "G1 feed Z-direction [mm/min]", None))
