...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label15 = QtWidgets.QLabel(self.millSettingsFrame)
        self.label15.setObjectName("label15")
        self.horizontalLayout_15.addWidget(self.label15)
        self.unitLabel_15 = QtWidgets.QLabel(self.millSettingsFrame)
        self.unitLabel_15.setMaximumSize(QtCore.QSize(31, 16777215))
        self.unitLabel_15.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.unitLabel_15.setText("[mm]")
        self.unitLabel_15.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.unitLabel_15.setObjectName("unitLabel_15")
        self.horizontalLayout_15.addWidget(self.unitLabel_15)
        self.gridLayout.addLayout(self.horizontalLayout_15, 9, 0, 1, 1)
        self.OffsetXYLineEdit = QtWidgets.QLineEdit(self.millSettingsFrame)
        self.OffsetXYLineEdit.setObjectName("OffsetXYLineEdit")
        self.gridLayout.addWidget(self.OffsetXYLineEdit, 9, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label15.setText(_translate("MainWindow", "Offset XY"))
