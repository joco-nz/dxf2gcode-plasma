...
class MainWindow(QMainWindow):
    ...
    def connectToolbarToConfig(self, project=False, block_signals=True):
        ...
        self.ui.actionJoinColinearLines.blockSignals(block_signals)
        self.ui.actionJoinColinearLines.setChecked(g.config.vars.General['join_colinear_line_segments'])
        self.ui.actionJoinColinearLines.blockSignals(False)
