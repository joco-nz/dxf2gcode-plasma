...
class Plugin(VarSpace):
    ...
    def __init__(self):
        ...
        self.callbacks = {'booltrue': self.varchanged_callback,
                          'boolfalse': lambda name, old, new:g.log.set_window_loglevel(new),

        }

        self.shapeset_handlers = {
                'export'    :  { 'menu_entry' : 'reference export', 'method':self.export},
                'transform' :  { 'menu_entry' : 'reference pocketing', 'method':self.transform},
 #               'xyzzy'     :  { 'menu_entry' : 'random plugin method','method':self.xyzzy}
        ...
        self.DESCRIPTION = 'reference plugins'
