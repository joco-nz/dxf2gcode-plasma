...
- Windows machine
  ...
  - Runtime dependencies:
    ...
    Note: if gswin32c is not on PATH then -gs option needs to be added to
...
-----------------------
  ...
  - macOS (not tested at all):
    ...
    $ python3 ./st-setup.py bdist_dmg # this should create Mac disk image
