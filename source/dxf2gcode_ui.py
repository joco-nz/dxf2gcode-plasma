...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.canvas = GLWidget(self.splitter)
        ...
        self.actionShow_path_directions = QtWidgets.QAction(MainWindow)
        ...
        self.actionShow_disabled_paths = QtWidgets.QAction(MainWindow)
        ...
        self.actionDelete_G0_paths = QtWidgets.QAction(MainWindow)
        ...
        self.actionRotate_all = QtWidgets.QAction(MainWindow)
        self.actionRotate_all.setEnabled(False)
        self.actionRotate_all.setObjectName("actionRotate_all")
        self.actionMove_WP_zero = QtWidgets.QAction(MainWindow)
        ...
        self.actionSplit_Line_Segments = QtWidgets.QAction(MainWindow)
        self.actionSplit_Line_Segments.setCheckable(True)
        self.actionSplit_Line_Segments.setObjectName("actionSplit_Line_Segments")
        self.actionAutomatic_Cutter_Compensation = QtWidgets.QAction(MainWindow)
        self.actionAutomatic_Cutter_Compensation.setCheckable(True)
        self.actionAutomatic_Cutter_Compensation.setEnabled(False)
        self.actionAutomatic_Cutter_Compensation.setObjectName("actionAutomatic_Cutter_Compensation")
        ...
        self.actionDrag_Knife = QtWidgets.QAction(MainWindow)
        self.actionDrag_Knife.setCheckable(True)
        self.actionDrag_Knife.setObjectName("actionDrag_Knife")
        ...
        self.menuTolerances.addSeparator()
        self.menuTolerances.addAction(self.actionSplit_Line_Segments)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolDiameterLabel.setText(_translate("MainWindow", "[mm]"))
        self.label_12.setText(_translate("MainWindow", "/ speed "))
        self.toolSpeedLabel.setText(_translate("MainWindow", "[rpm]"))
        self.label_13.setText(_translate("MainWindow", "start rad. (comp) "))
        self.startRadiusLabel.setText(_translate("MainWindow", "[mm]"))
        self.zInitialMillDepthLineEdit.setToolTip(_translate("MainWindow", "Milling will start at Z = \"Worpiece top Z\" - \"Z infeed depth\""))
        self.label_7.setText(_translate("MainWindow", "Feed rate XY"))
        self.unitLabel_8.setText(_translate("MainWindow", "[mm/min]"))
        self.label_8.setText(_translate("MainWindow", "Z Final mill depth"))
        self.unitLabel_7.setText(_translate("MainWindow", "[mm]"))
        self.label_9.setText(_translate("MainWindow", "Z Infeed depth"))
        self.unitLabel_6.setText(_translate("MainWindow", "[mm]"))
        self.label_5.setText(_translate("MainWindow", "Z Safety margin"))
        self.unitLabel_4.setText(_translate("MainWindow", "[mm]"))
        self.label_6.setText(_translate("MainWindow", "Z Retraction area"))
        self.unitLabel_3.setText(_translate("MainWindow", "[mm]"))
        self.label_14.setText(_translate("MainWindow", "Z Workpiece top"))
        self.unitLabel_5.setText(_translate("MainWindow", "[mm]"))
        self.startAtXLabel.setText(_translate("MainWindow", "Start X"))
        self.unitLabel_1.setText(_translate("MainWindow", "[mm]"))
        self.label_10.setText(_translate("MainWindow", "Feed rate Z"))
        self.unitLabel_9.setText(_translate("MainWindow", "[mm/min]"))
        self.startAtYLabel.setText(_translate("MainWindow", "Start Y"))
        self.unitLabel_2.setText(_translate("MainWindow", "[mm]"))
        ...
        self.actionShow_path_directions.setText(_translate("MainWindow", "Show path directions"))
        self.actionShow_path_directions.setStatusTip(_translate("MainWindow", "Always shows the path direction in the plot (not only while selected)"))
        self.actionShow_disabled_paths.setText(_translate("MainWindow", "Show disabled paths"))
        self.actionAutoscale.setText(_translate("MainWindow", "Autoscale"))
        self.actionDelete_G0_paths.setText(_translate("MainWindow", "Delete G0 paths"))
        ...
        self.actionRotate_all.setText(_translate("MainWindow", "Rotate all"))
        self.actionMove_WP_zero.setText(_translate("MainWindow", "Move WP zero"))
        self.actionAbout.setText(_translate("MainWindow", "About"))
        self.actionOptimize_Shape.setText(_translate("MainWindow", "Optimize Paths "))
        ...
        self.actionSplit_Line_Segments.setText(_translate("MainWindow", "Split Line Segments"))
        self.actionSplit_Line_Segments.setStatusTip(_translate("MainWindow", "Split line segments, e.g. can be used for compensation (G41/G42) in combination with EMC"))
        self.actionAutomatic_Cutter_Compensation.setText(_translate("MainWindow", "Automatic Cutter Compensation"))
